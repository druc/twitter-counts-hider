...
if (!localStorage.hasOwnProperty('hideTwitterStats')) {
    localStorage.hideTwitterStats = true;
    hideTwitterStats();
...
} else if (localStorage.hideTwitterStats === 'true') {
    localStorage.hideTwitterStats = false;
